...
class GraphCanvas(tk.Canvas):
    def __init__(self, parent, width=500, height=400, **kwargs):
        super().__init__(parent, width=width, height=height, bg='white', bd=2, relief='sunken', **kwargs)
        self.graph = {}
        ...
        for u in self.graph:
            ...
            for v,w in self.graph[u]:
                ...
                if length > 0:
                    ...
                    mx += nx
                    my += ny
                self.create_text(mx, my, text=str(w), fill='#1A1A1A', font=('Arial',12,'bold'), bg='white', pad=2)
